...
public class MainPageObject {
    ...
    public boolean waitForTextPresentInField(By by, String expected_value, String error_message, long timeOutInSeconds) {
        WebDriverWait wait = new WebDriverWait(driver, timeOutInSeconds);
        wait.withMessage(error_message + "\n");
        return wait.until(
    ...
    public void clickElementToTheRightRightUpperCorner(String locator, String error_message)
    {
